...
import ProjectListCard from "../../../components/Project/projectListCard/ProjectListCard";
import {
  Container,
  ContentWrapper,
  FilterBar,
...
const DUMMY_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    thumbnail: "https://via.placeholder.com/100/fff0e8/000000?text=FoodTable",
    teamSize: "1명",
    role: "개인 프로젝트",
    startDate: "2025.08",
    endDate: "2025.11",
  },
  {
    ...
    thumbnail: "https://via.placeholder.com/100/e8fff0/000000?text=GreenAI",
    teamSize: "1명",
    role: "개인 프로젝트",
    startDate: "2025.08",
    endDate: "2025.11",
  ...
  },
  {
    ...
    thumbnail: "https://via.placeholder.com/100/e8f5ff/000000?text=FitTracker",
    teamSize: "1명",
    role: "개인 프로젝트",
    startDate: "2025.08",
    endDate: "2025.11",
...
const ProjectList = () => {
  ...
  const [displayedProjects, setDisplayedProjects] =
    useState<Project[]>(DUMMY_PROJECTS);
      ...
      <Container>
        <ContentWrapper>
          <FilterBar>
            ...
            <AddButton onClick={handleAddProject}>+ 추가 생성</AddButton>
          </FilterBar>
